...
description = "awkのように列を扱い、日時やIPアドレスも比較・加工できる、S式のテキスト処理ツールを作っています。"
date = 2026-09-20
+++
...
名前は、awkの響きが「億（おく）」に少し似ていることから、その次の単位「兆（ちょう）」にしました。Composable, Handy, One-liner friendlyの頭文字でもあります。
